...
firm: binary screeninit
	firmtool build $(OUTPUT).firm -n 0x08006800 -A 0x08006800 -D $(OUTPUT).bin $(OUTPUT_D)/screeninit.elf -C NDMA XDMA -S nand-retail
	firmtool build $(OUTPUT)_dev.firm -n 0x08006800 -A 0x08006800 -D $(OUTPUT).bin $(OUTPUT_D)/screeninit.elf -C NDMA XDMA -S nand-dev
